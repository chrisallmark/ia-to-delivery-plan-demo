...
| 3 | Write `plan/features/<ia-slug>.md` per IA |
| 4 | Write `plan/stories/<ia-slug>/<si-no>-<component>.md` per SI with independent T-shirt estimates |
| 5 | Write `plan/tshirt-validation.md` comparing IA vs story estimates |
| 6 | Write `plan/dependency-graph.md` (prose + Mermaid) |
| 7 | Write `plan/delivery-plan.md` (Mermaid Gantt + critical path + key risks) |
